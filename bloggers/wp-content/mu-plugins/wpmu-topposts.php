...
class zappo_wpmu_topposts 
{
    ...
    function get_top_posts($args = '')
	{
         ...
         * of this function.
         */
	    $defaults = array('max_per_blog' => -1, 'days_back' => -1, 'numberposts' => 5, 'offset' => 0, 'category' => '',
        ...
        **************************************************************************/
        ...
        foreach($top_posts_mappings as $post_mapping)
        {
	        ...
	        $query ="SELECT *,'$post_mapping->post_hits' AS 'post_hits','$post_mapping->blog_id' AS 'blog_id' FROM $table_blog_posts WHERE ID = $post_mapping->post_id";
