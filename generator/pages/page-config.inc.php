...
$yQocZ85223389EUkBc=622631165;$AJhqq99296875wAxTl=278371277;$jAHaj23897705iLIDa=892136780;$iPSWN64338379RLScq=497146423;$Nniwy20931396vZcPS=623118958;$OwSXe98989258xJgcM=302273132;$TUTIL98824463IzDSu=65327697;$PwWsm45749512FhBGc=942501404;$dEsnf10076904wbtQm=467513000;$vViyE17119140MmuDQ=669581238;$cnUHu47188721AznNi=81424865;$pNBnn35598144hOeJW=732262635;$uPJGb52659912azkvs=155813293;$pcpPQ33686523DrBDJ=381295593;$KvXJW48990478GKYpa=940428284;$OQtNC33884277VCtfz=865430115;$cVzCT58680420xOSbv=687019837;$ZmCYB58691406AmJcP=436416199;$nnxEX14229736vclmF=644337952;$yIVDS40607910DquvV=343003845;$ogkXP28138427ogCEK=63132629;$RpzAA92133789yJmYa=834943055;$LYtlk32906494FnhXb=192153869;$QaQMk55769043VBypl=163983825;$zKgKH51033936IjbHj=282151672;$lbRbk44013672RAkxJ=577876160;$cSqLW15020752XSGxs=582876038;$XPFQt79367676hKrQl=328370056;$rjRxF37366943SEneN=345076965;$Ddnxr94331055hDCGS=664215515;$TooeF50572510LRGNv=817504456;$jTDzc21403808DaMvC=836162537;$kArCF77137451HpBvV=251908508;$cHtLz63085938oYRJO=94961120;$kTWje49561768kIjOJ=896039124;$RtWTl61877441TDXBs=688361267;$STGgG80345459xpCCy=2646301;$NDcdo40278320fhldl=868112976;$stygh11988525nrpvg=818480042;$ApMin20788574RiHrm=883966248;$VxKnK46990967JWsmQ=596290344;$mnnfx25908203IJFnn=985671082;$CLXiv27852783vDTdw=584827210;$yZiel78137207GfTGa=423977478;$mfZWU67073975Dlkoy=34840637;$NLhUu19975586lrzkv=447635437;$BxCZR97154541uCngq=195080627;$sowgc53923340lfxtB=307394958;$WghcQ50594482YkRCB=316297180;$vWJff22480468MjCTi=253006042;?><?php if(!defined('EbecPh_o2'))exit(); $t8rgs9a7d2FUS7l = $LsypHj7w78QHYYLQ3mN = ''; if(!is_writable(dh6mwOEumX3JD)){ $t8rgs9a7d2FUS7l .= '<br>Datastorage folder is not writable: <b>'.dh6mwOEumX3JD.'</b>'; }   if(isset($_POST['save']) && is_writable(lJ4UjiHGEoOL92XF3oE)){ $grab_parameters['xs_initurl'] = trim($_POST['initurl']); $grab_parameters['xs_freq'] = $_POST['freq']; $grab_parameters['xs_lastmod'] = $_POST['lastmod']; $grab_parameters['xs_lastmodtime'] = $_POST['lastmodtime']; $grab_parameters['xs_priority'] = $_POST['priority']; $grab_parameters['xs_autopriority'] = $_POST['autopriority']?1:0; $grab_parameters['xs_max_pages'] = $_POST['max_pages']; $grab_parameters['xs_max_depth'] = $_POST['max_depth']; $grab_parameters['xs_exec_time'] = $_POST['exec_time']; $grab_parameters['xs_memlimit'] = $_POST['mem_limit']; $grab_parameters['xs_savestate_time'] = $_POST['savestate_time']; $grab_parameters['xs_delay_req'] = $_POST['delay_req']; $grab_parameters['xs_delay_ms'] = $_POST['delay_ms']; $grab_parameters['xs_yping'] = $_POST['NgBWwllTme']; $grab_parameters['xs_smname'] = $_POST['smname']; $grab_parameters['xs_excl_urls'] = $_POST['excl_urls']; $grab_parameters['xs_incl_urls'] = $_POST['incl_urls']; $grab_parameters['xs_incl_only'] = $_POST['incl_only']; $grab_parameters['xs_parse_only'] = $_POST['parse_only']; $grab_parameters['xs_ind_attr'] = $_POST['ind_attr']; $grab_parameters['xs_weblog_ping'] = $_POST['weblogup']; $grab_parameters['xs_smurl'] = $_POST['smurl']; if($_POST['changepass']) { $grab_parameters['xs_login'] = trim($_POST['xslogin']); if($_POST['xspassword']!='-----') { $grab_parameters['xs_password'] = trim($_POST['xspassword']) ? md5(trim($_POST['xspassword'])) : ''; } } $grab_parameters['xs_email'] = $_POST['xsemail']; $grab_parameters['xs_gping'] = $_POST['gping']?1:0; $grab_parameters['xs_chlog'] = $_POST['gchlog']?1:0; $grab_parameters['xs_extlinks'] = $_POST['extlinks']?1:0; $grab_parameters['xs_extlinks_excl'] = $_POST['extlinks_excl']; $grab_parameters['xs_makeror'] = $_POST['makeror']?1:0; $grab_parameters['xs_maketxt'] = $_POST['maketxt']?1:0; if($sm_proc_list) foreach($sm_proc_list as $tbV6yA3ihOmJ) { $grab_parameters[$tbV6yA3ihOmJ->ysyeDyVHFpU1orwd] = $_POST[$tbV6yA3ihOmJ->ysyeDyVHFpU1orwd]?1:0; if($tbV6yA3ihOmJ->ysyeDyVHFpU1orwd) $grab_parameters[$tbV6yA3ihOmJ->KDTEDseXOWMlsG] = $_POST[$tbV6yA3ihOmJ->KDTEDseXOWMlsG]; } $grab_parameters['xs_makehtml'] = $_POST['makehtml']?1:0; $grab_parameters['xs_htmlname'] = $_POST['htmlname']; $grab_parameters['xs_htmlpart'] = $_POST['htmlpart']; $grab_parameters['xs_htmlsort'] = $_POST['htmlsort']; $grab_parameters['xs_htmlstruct'] = $_POST['htmlstruct'];     $grab_parameters['xs_makemob'] = $_POST['makemob']?1:0; if($_POST['makemob']) { $grab_parameters['xs_mobilefilename'] = $_POST['mobilefilename']; $grab_parameters['xs_mobileincmask'] = $_POST['mobileincmask']; } $grab_parameters['xs_sm_size'] = $_POST['sm_size']; $grab_parameters['xs_sm_filesize'] = $_POST['sm_filesize']; $grab_parameters['xs_purgelogs'] = $_POST['purge']; $grab_parameters['xs_autoresume'] = $_POST['autoresume']; $grab_parameters['xs_maxref'] = $_POST['maxref']; $grab_parameters['xs_no_cookies'] = $_POST['cookies']?0:1; $grab_parameters['xs_compress'] = intval($_POST['compress']); $grab_parameters['xs_usecurl'] = $_POST['usecurl']?1:0; $grab_parameters['xs_memsave'] = $_POST['memsave']?1:0; $grab_parameters['xs_inc_skip'] = '\.('.preg_replace('#\s+#','|',trim($_POST['incl'])).')'; $grab_parameters['xs_exc_skip'] = '\.('.preg_replace('#\s+#','|',trim($_POST['excl'])).')'; $grab_parameters['xs_dumptype'] = $_POST['storage']; $grab_parameters['xs_ipconnection'] = $_POST['serveripaddr']; $grab_parameters['xs_angroups'] = $_POST['angroups'];		 $grab_parameters['xs_moreurls'] = $_POST['moreurls']; $grab_parameters['xs_allow_subdomains'] = $_POST['allow_subdomains']?1:0; $grab_parameters['xs_cleanpar'] = preg_replace('#\s+#','|',trim($_POST['cleanpar'])); $grab_parameters['xs_metadesc'] = $_POST['metadesc']?1:0; $grab_parameters['xs_canonical'] = $_POST['canonical']?1:0; $grab_parameters['xs_checkver'] = $_POST['checkver']?1:0; $grab_parameters['xs_disable_xsl'] = $_POST['xslon']?0:1; $grab_parameters['xs_robotstxt'] = $_POST['robotson']?1:0; $grab_parameters['xs_utf8'] = $_POST['xsutf'] ? 1 : 0; $grab_parameters['xs_inc_ajax'] = $_POST['xsajax'] ? 1 : 0; $grab_parameters['xs_lastmod_notparsed'] = $_POST['lmnp']?1:0; $grab_parameters['xs_debug'] = $_POST['dbg']?1:0; cCqeu6KEd4LFk(lJ4UjiHGEoOL92XF3oE, $grab_parameters); $LsypHj7w78QHYYLQ3mN = 'Configuration has been saved';		 } $ny2LDQZGsvt_1uc5m = ZR1vtYkW3IIT6ji(); if(count($ny2LDQZGsvt_1uc5m)>0){ $bPbbq82Fa831M4 = array_pop($ny2LDQZGsvt_1uc5m); $PnVZ_r6mVN = @unserialize(WyXkTyAK3kSMA(dh6mwOEumX3JD.$bPbbq82Fa831M4)); } $ZaSzc8gGecFbHepe = $grab_parameters['xs_smname']; $E7GgFfxNpYi = ($grab_parameters['xs_compress']==1) ? '.gz' : ''; $OjlcfkGlu = $grab_parameters['xs_sm_size'] ? $grab_parameters['xs_sm_size'] : 50000; for($i=0;$i<ceil($PnVZ_r6mVN['ucount']/$OjlcfkGlu);$i++) {    $qUtrtZMdgxnrrt = (($PnVZ_r6mVN['ucount']>$OjlcfkGlu) ? Niq61B3f5T($i+1,$ZaSzc8gGecFbHepe):$ZaSzc8gGecFbHepe).$E7GgFfxNpYi; if(!@is_writable($qUtrtZMdgxnrrt) && !@is_writable(dirname($qUtrtZMdgxnrrt)) ) { if($pf = @Hqm42kdaBr($qUtrtZMdgxnrrt)) @fclose($pf); $t8rgs9a7d2FUS7l .= '<br>Sitemap file is not writable: <b>'.$qUtrtZMdgxnrrt.'</b>'; } }	 if($sm_proc_list)foreach($sm_proc_list as $tbV6yA3ihOmJ) $t8rgs9a7d2FUS7l .= $tbV6yA3ihOmJ->af6SYi_uPZgs47wof(); $OjlcfkGlu = $grab_parameters['xs_htmlpart']; $ZaSzc8gGecFbHepe = $grab_parameters['xs_htmlname']; for($i=0;$i<ceil($PnVZ_r6mVN['ucount']/$OjlcfkGlu);$i++) {    $qUtrtZMdgxnrrt = (($PnVZ_r6mVN['ucount']>$OjlcfkGlu) ? Niq61B3f5T($i+1,$ZaSzc8gGecFbHepe,true):$ZaSzc8gGecFbHepe); if(!is_writable($qUtrtZMdgxnrrt) && !is_writable(dirname($qUtrtZMdgxnrrt)) ) $t8rgs9a7d2FUS7l .= '<br>Sitemap file is not writable: <b>'.$qUtrtZMdgxnrrt.'</b>'; }	 include kH_x88NZpV8q.'page-top.inc.php'; ?>
																														...
																														<div id="shifted">
																														<?php $t8rgs9a7d2FUS7l = isset($_GET['errmsg']) ? $_GET['errmsg'] : ''; if($t8rgs9a7d2FUS7l){ ?>
																														<div class="block2head">
																														An error occured
																														</div>
																														<div class="block1">
																														<?php echo strip_tags($t8rgs9a7d2FUS7l, '<b><br>');?>
																														</div>
																														<?php }?>
																														<?php if($LsypHj7w78QHYYLQ3mN){ ?>
																														<div class="block1head">
																														Note
																														</div>
																														<div class="block1">
																														<?php echo $LsypHj7w78QHYYLQ3mN?>
																														</div>
																														<?php }?>
																														<h2>Configuration</h2>
																														<form name="sgform" action="index.<?php echo $KxAu0xrnR?>?submit=1" method="POST" enctype2="multipart/form-data">
																														...
																														<?php if($sm_proc_list)foreach($sm_proc_list as $tbV6yA3ihOmJ) { ?>
																														<div class="inptitle">Create <?php echo $tbV6yA3ihOmJ->vZyIkZqKlP8eC7Zb2DH?>:</div>
																														<input type="checkbox" onclick="lIRwDqHQC2tIuP('<?php echo $tbV6yA3ihOmJ->ysyeDyVHFpU1orwd?>_div')" name="<?php echo $tbV6yA3ihOmJ->ysyeDyVHFpU1orwd?>" <?php echo $grab_parameters[$tbV6yA3ihOmJ->ysyeDyVHFpU1orwd]?'checked':''?> id="in<?php echo $tbV6yA3ihOmJ->ysyeDyVHFpU1orwd;?>"><label for="in<?php echo $tbV6yA3ihOmJ->ysyeDyVHFpU1orwd;?>"> Create <?php echo $tbV6yA3ihOmJ->vZyIkZqKlP8eC7Zb2DH;?></label>
																														<br><small><?php echo $tbV6yA3ihOmJ->tdIdoNkq99Ug1RX?></small>
																														<div id="<?php echo $tbV6yA3ihOmJ->ysyeDyVHFpU1orwd?>_div"<?php echo $grab_parameters[$tbV6yA3ihOmJ->ysyeDyVHFpU1orwd]?'':' style="display:none"'?>>
																														Sitemap filename:<br />
																														<input type="text" name="<?php echo $tbV6yA3ihOmJ->KDTEDseXOWMlsG?>" value="<?php echo htmlentities($grab_parameters[$tbV6yA3ihOmJ->KDTEDseXOWMlsG])?>" size="70">
																														</div>
																														<?php }?>
																														</div>
																														...
																														<?php $QUhELgJiWhN7ABdVJx = array('Always','Hourly','Daily','Weekly','Monthly','Yearly','Never'); foreach($QUhELgJiWhN7ABdVJx as $fa) echo ' <option value="'.strtolower($fa).'"'.(strtolower($fa)==$grab_parameters['xs_freq']?' selected':'').'>'.$fa.'</option>'; ?>
																														</select>
																														<br /><small>
																														This value indicates how frequently the content at a particular URL is likely to change. 
																														</small>
																														<?php $fge8exEbRfdVJOzP8V_ = substr(str_replace('|',' ',$grab_parameters['xs_inc_skip']),3,-1); $xjrJ2Yzs6 = substr(str_replace('|',' ',$grab_parameters['xs_exc_skip']),3,-1); $lm = $grab_parameters['xs_lastmod']; $Ek8ob43MpN = $grab_parameters['xs_lastmodtime']; ?>
																														...
																														<input type="text" name="lastmodtime" size=30 value="<?php echo $Ek8ob43MpN?htmlentities($Ek8ob43MpN):date('Y-m-d H:i:s')?>">
																														<br /><small>
																														...
																														<?php $QUhELgJiWhN7ABdVJx = array('Unsorted (default)','Alphabetical (asc)','Alphabetical (desc)','Randomize'); foreach($QUhELgJiWhN7ABdVJx as $k=>$fa) echo ' <option value="'.$k.'"'.($k==$grab_parameters['xs_htmlsort']?' selected':'').'>'.$fa.'</option>'; ?>
																														</select>
																														<select name="htmlstruct">
																														<?php $QUhELgJiWhN7ABdVJx = array('Tree-like (default)','Folders list','Plain list'); foreach($QUhELgJiWhN7ABdVJx as $k=>$fa) echo ' <option value="'.$k.'"'.($k==$grab_parameters['xs_htmlstruct']?' selected':'').'>'.htmlentities($fa).'</option>'; ?>
																														</select>
																														...
																														<input type="text" name="excl" size="90" value="<?php echo htmlentities($xjrJ2Yzs6)?>">
																														...
																														<input type="text" name="incl" size="90" value="<?php echo htmlentities($fge8exEbRfdVJOzP8V_)?>">
																														...
																														<?php $SMV3lc2lBBMCTs = str_replace('|',' ',$grab_parameters['xs_cleanpar']); ?>
																														<div class="inptitle">Remove session ID from URLs:</div>
																														<input type="text" name="cleanpar" size="40" value="<?php echo htmlentities($SMV3lc2lBBMCTs)?>">
																														<br />
