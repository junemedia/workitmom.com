...
?><div id="featured_quote" class="block">
	...
	<div class="header">
		...
		<a href="<?= SITEURL; ?>/questions/#questions_listing" class="button_dark scroll"><span>See All</span></a>
	...
	<div class="content">
		...
		<div class="question fl">
			<strong><a href="<?= $link; ?>">&ldquo;<?= Text::trim($featuredQuestion->title, 100, false); ?>&rdquo;</a></strong>
	...
	<? if(isset($featuredAnswer->body)) { ?>
		...
		<div class="answer text-content fl">
			&ldquo;<?= Text::trim($featuredAnswer->body, 100, false); ?>&rdquo;&nbsp;&nbsp;<span style="white-space:nowrap;">-- <?= $featuredAnswer->author->name; ?></span>
		</div>
		<div class="clear"></div>
	<? } ?>
