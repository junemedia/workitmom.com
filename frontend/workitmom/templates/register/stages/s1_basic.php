<!--INFOLINKS_OFF-->
	<div class="wrapper">
		<div class="content">
			...
			<form action="<?= SITEURL ?>/register" method="post"><div>
				...
				<dl>
					...
					<dd>
						...
						<small class="fieldhint">Please enter your city OR your state OR your country in this field. Please make sure to select your location from the list before moving on to the next field.</small>
