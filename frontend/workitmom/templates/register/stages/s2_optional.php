<!--INFOLINKS_OFF-->
	<div class="wrapper">
		<div class="content">
			<form action="<?= SITEURL ?>/register" method="post" enctype="multipart/form-data"><div>

				<p class="text-content" style="margin-bottom: 10px;">
				The following information is not required but will help you have a richer experience at Work It, Mom!. If you'd like to fill it out later, just click the <strong>'complete sign up'</strong> at the bottom of this page.
				</p>
