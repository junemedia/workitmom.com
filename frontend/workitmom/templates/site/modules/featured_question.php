...
// THIS IS MEMBER QUESTION, NOT FEATURED QUESTION!!!! (i.e. category landing pages only)
...
?><div id="featured_quote" class="block">
	...
	<div class="content">
		...
		<div class="question fl">
			<strong><a href="<?= $link; ?>">&ldquo;<?= Text::trim($featuredQuestion->title, $trimQuestionEvenMore?100:180, false); ?>&rdquo;</a></strong>
	...
	<? if(isset($featuredAnswer->body)) { ?>
		...
		<div class="answer text-content fl">
			&ldquo;<?= $trimAnswer ? Text::trim($featuredAnswer->body, 100, false) : $featuredAnswer->body; ?>&rdquo;&nbsp;&nbsp;<span style="white-space:nowrap;">-- <?= $featuredAnswer->author->name; ?></span>
		</div>
		<div class="clear"></div>
	<? } ?>
