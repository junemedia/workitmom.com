	...
	<div id="main-content" class="marketplace">
		...
		<div class="panel-left">
			...
			<div id="market_content" class="content">
				...
				<p align="center" class="register">
				 	<a href="<?= SITEURL ?>/register"><img src="<?= SITEASSETURL ?>/images/site/button_register_marketplace.png"/></a><br />
					Existing members, please <a href="<?= SITEURL ?>/account">click here</a> to log in and submit your listing.
				</p>
			</div>
